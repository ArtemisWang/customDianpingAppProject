...
2. 猜你喜欢模块网络请求包括三种动作actionTypes：FETCH_LIKES_REQUEST请求、FETCH_LIKES_SUCCESS成功、FETCH_LIKES_FAILURE失败
...
3. 在middleware中创建api.js，强化中间件处理请求数据这一异步action，简化home.js中代码